...
class MSSTrans(nn.Module):
    def __init__(self, label_dim=1):
        ...
        self.transformer_4096_fined = Transformer(src_vocab_size, src_pad_idx)  # num_layers=6, heads=8
        self.transformer_256_fined = Transformer(src_vocab_size, src_pad_idx)
        self.transformer_16_fined = Transformer(src_vocab_size, src_pad_idx)
